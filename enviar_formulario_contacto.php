...
if(isset($_POST['email'])) {
    ...
    $email_to = "info@dcsguatemala.com";
 
    $email_subject = "Contactando a DCS Guatemala";
...
<img src="images/0.1.png" width="240" height="120" alt="logo">
<h1>Sus datos fueron enviados satisfactoriamente.</h1>
<h3>Por favor espere unos segundos, en lo que lo regresamos a la página principal.</h3>
